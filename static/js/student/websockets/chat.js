...
class ChatSocketManager {
     ...
     */
    leaveCurrentRoom() {
        if (this.currentInquiryId && this.connectionState === 'connected') {
     ...
     */
    sendMessage(content, clientMsgId = null) {
        if (this.connectionState !== 'connected' || !this.currentInquiryId) {
            if (this.messageCallbacks.onError) {
    ...
    /**
     * Update internal connection state and notify callbacks
     * @private
     */
    _updateConnectionState(newState) {
        if (this.connectionState !== newState) {
            ...
            if (this.messageCallbacks.onConnectionStatusChange) {
                this.messageCallbacks.onConnectionStatusChange(newState);
            }
        }
    }
     ...
     */
    startTyping() {
        if (this.connectionState !== 'connected' || !this.currentInquiryId) return;
